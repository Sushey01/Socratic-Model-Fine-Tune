#!/usr/bin/env python3
"""ScienceQA eval for Qwen2.5-7B QLoRA adapters."""
...
from train import init_wandb, log_scienceqa_to_wandb, wandb_enabled
from train_qwen import from_pretrained_qwen
from train_qwen25 import (
    DEFAULT_DATA,
    DEFAULT_MODEL,
    DEFAULT_OUTPUT,
...
def main() -> None:
    ...
    os.environ.setdefault("WANDB_RUN_NAME", "qwen25-7b-instruct-eval")
    apply_qwen25_wandb_project()
    ...
    print("Running ScienceQA...", flush=True)
